class Student(object):
    ...
    # This function only cares about student verification
        if username == 'student@uowmail.edu.au' and password == 'password123':
            return True
        return False
    ...
    def get_current_bookings(self, username):
        return [
            ...
            # Past Bookings
            {"id": "b4", "room_name": "Lecture Hall B.1.1", "date": "10 Jan 2026", "time": "08:30 - 10:30", "status": "Completed", "category": "past", "capacity": 200, "block": "B"},
            
            # Cancelled Booking
            {"id": "b5", "room_name": "Study Room C.3.5", "date": "25 May 2026", "time": "13:30 - 15:30", "status": "Cancelled", "category": "cancelled", "capacity": 6, "block": "C"}
        ]
